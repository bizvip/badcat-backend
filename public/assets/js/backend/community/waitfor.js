define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
	$.fn.bootstrapTable.locales[Table.defaults.locale]['formatSearch'] = function(){return "待审核";};
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'community/waitfor/index' + location.search,
                    add_url: 'community/waitfor/add',
                    edit_url: 'community/waitfor/edit',
                    del_url: 'community/waitfor/del',
                    multi_url: 'community/waitfor/multi',
                    table: 'community',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
	                    ...
	                    // 分类
	                    {field: 'class', title: __('Class'),formatter: Table.api.formatter.status, searchList: {'0': __('短文'), '2': __('图片')}},
	                    // 图片
                        ...
                        // 收费方式
	                    {field: 'istoll', title: __('Istoll'),formatter: Table.api.formatter.status, searchList: {'n': __('免费'), 'y': __('会员')}},
                        // 审核状态
