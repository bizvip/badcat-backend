            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
	                    ...
	                    // 问题图片
                        {field: 'ask_image', title: __('Ask_image'), events: Table.api.events.image, formatter: Table.api.formatter.images,operate:false},
                        // 问题内容
                        {field: 'ask_text', title: __('Ask_text'), formatter: function(value){return value.toString().substr(0, 20)}},
                        // 点赞数
