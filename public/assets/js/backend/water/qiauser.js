define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
	$.fn.bootstrapTable.locales[Table.defaults.locale]['formatSearch'] = function(){return "吃瓜（用户列表）";};
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'water/qiauser/index' + location.search,
                    add_url: 'water/qiauser/add',
                    edit_url: 'water/qiauser/edit',
                    del_url: 'water/qiauser/del',
                    multi_url: 'water/qiauser/multi',
                    table: 'water',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        // 用户ID
	                    {field: 'user_id', title: __('User_id'),formatter: Table.api.formatter.status},
                        // 用户名
