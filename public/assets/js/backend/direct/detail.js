        ...
        index: function () {
            ...
            Table.api.init({
                extend: {
                    ...
                    // add_url: 'direct/detail/add',
                    // edit_url: 'direct/detail/edit',
                    // del_url: 'direct/detail/del',
                    // multi_url: 'direct/detail/multi',
                }
            });
                        ...
                        {field: 'is_tuijian', title:'是否推荐', formatter: Table.api.formatter.status, searchList: {'0': '未推荐', '1': '已推荐'}},
	                    {
		                    ...
		                    buttons: [
			                    ...
			                    
			                    {
                        	        ...
                        	        url: 'direct/detail/fenleituijian?title={title}&housename={housename}&img={img}&address={address}&houseimg={houseimg}&roomurl={roomurl}&xuhao={xuhao}'
                                },
			                    {
				                    name: 'addtabs',
				                    text: '取消推荐',
