define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'video/topping/index' + location.search,
                    add_url: 'video/topping/add',
                    edit_url: 'video/topping/edit',
                    del_url: 'video/topping/del',
                    multi_url: 'video/topping/multi',
                    table: 'topping',
                }
            });
