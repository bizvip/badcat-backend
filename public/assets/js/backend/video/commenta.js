define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
	...
	var Controller = {
		index: function () {
			...
			Table.api.init({
				extend: {
					index_url: 'video/commenta/index' + location.search,
				    add_url: 'video/commenta/add',
					edit_url: 'video/commenta/edit',
					del_url: 'video/commenta/del',
					multi_url: 'video/commenta/multi',
			...
			table.bootstrapTable({
				...
				columns: [
					[
				        ...
				        // 等级
						{field: 'user.level', title: __('level')},
						{
							field: 'tong',
							title: __('审核状态'),
							...
							buttons: [
								{
									...
									icon: '',
									url: 'video/commenta/tong?tong=1',
								...
								},
								{
									...
									confirm: '您确定要拒绝吗',
									icon: '',
									url: 'video/commenta/tong?tong=2',
