define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'tvideo/topping/index' + location.search,
                    add_url: 'tvideo/topping/add',
                    edit_url: 'tvideo/topping/edit',
                    del_url: 'tvideo/topping/del',
                    multi_url: 'tvideo/topping/multi',
                    table: 'topping',
                }
            });
