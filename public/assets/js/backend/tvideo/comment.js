define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
	...
	var Controller = {
		index: function () {
			...
			Table.api.init({
				extend: {
					index_url: 'tvideo/comment/index' + location.search,
				    add_url: 'tvideo/comment/add',
					edit_url: 'tvideo/comment/edit',
					del_url: 'tvideo/comment/del',
					multi_url: 'tvideo/comment/multi',
					table: 'movie_comment',
				}
			});
							...
							buttons: [
								{
									...
									icon: '',
									url: 'tvideo/comment/tong?tong=1',
								...
								},
								{
									...
									confirm: '您确定要拒绝吗',
									icon: '',
									url: 'tvideo/comment/tong?tong=2',
