...
(function (window, undefined) {
        ...
        select: function (hasDummy) {
            ...
            if (_IERANGE) {
                ...
                if (doc !== document) {
                    ...
                    if(sc.children.length>1 && sel.focusOffset>1){
    ...
    function _getInitHtml(options) {
        ...
        var arr = [
            ...
            // 编辑框
            'body {margin:0;padding:5px 35px;}',
    ...
    self.plugin.image = {
        edit: function () {
            ...
            self.plugin.imageDialog({
                ...
                // 图片大小（宽）
                imageWidth: img ? img.attr('width') : '100%',
                // 图片大小（高）
                imageHeight: img ? img.attr('height') : '',
                // 圆角
                // imageHeight: img ? img.attr('border') : '10px',
                // 图片说明
    ...
    self.plugin.media = {
        edit: function () {
            var html = [
                ...
                '<div class="row-right">',
                // 上传视频
                '<input type="text" id="keHeight" class="ke-input-text ke-input-number" name="height" value="450" maxlength="4" />',
                '</div>',
                '</div>',
