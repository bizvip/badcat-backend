                ...
                try {
                    ...
                    if (isset(input()['comments'])) {
                        ...
                        for ($i = 0; $i < $size; $i++) {
                            ...
                            Comment::insert(['name' => $name, 'avator_image' => $photo, 'content' => $comment[$i], 'community_id' => $result, 'class' => 0, 'tong' => 1, 'creat_time' => date('Y-d-m H:i:s'), 'zd' => 0,'level'=>mt_rand(0,2)]);
                        }
                    }
                    Db::commit();
