...
class Yk extends Api
{
    ...
    //         if($req['type'] && $req['type'] == 'dsp'){
    //             $video=Tvs::get($req['video_id']);//Tvs::where('id',$req['video_id'])->find();//Dvs::where('id',$req['video_id'])->find();
           
    //             // Log::record(777788822);
    //             // Log::record($video);
    ...
    //                 }
    //             }else{
    //                  $this->error('游客不能看付费视频', [], 100);
    //             }
    //         }else{
    //             $video=Video::get($req['video_id']);
           
    //             // Log::record(777788833);
    //             // Log::record($video);
    ...
    //     // $ykc = Config::where('name', 'ykc')->value('value');
    //     // $tvideo = Config::where('name', 'tvideo')->value('value');
    //     $mrgk = Config::where('name', 'mrgk')->value('value');
    //     // $zcc = Config::where('name', 'zcc')->value('value');
    //     $req = $request->post();
    //     $yk = $this->model->where(['code' => $req['code']])->find();
    ...
    //         // 'zcc'=> intval($zcc),
    //         'mrgk' => intval($mrgk),
    //         // 'tvideo' => intval($tvideo),
    //         // 'gkcs' => intval($yk['gkcs']),
    //         // 'tgkcs' => intval($yk['tgkcs']),
    //         'yyy' =>$yk
    //     ];
